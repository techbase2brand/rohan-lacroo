...
const EditDocketModal = ({ visible, onSave, onSplit, editOperatorDocket }) => {
        ...
        >
            <View style={styles.modalContainer}>
                <View style={styles.modalContent}>
                    ...
                    <LabourDocket hideBUtton={true} />
                    <View style={[styles.modalButtons, { position: "absolute", bottom: 20, backgroundColor: "#fff",paddingHorizontal:10 }]}>
